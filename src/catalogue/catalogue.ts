...
class Catalogue {
    ...
    constructor() {
        ...
        // 增加 kindle oasis 按钮点击监听
        const listener = this.handlePageUpDown.bind(this);
    ...
    checkHeight(): void {
        let height = this.element.offsetHeight - 110 - 20;
        let oo = height % 80;
        if (oo < 10) {
            oo += 80;
        }
    ...
    handlePageUpDown(e: KeyboardEvent): void {
        if (this.loading === true) {
